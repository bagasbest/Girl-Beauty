...
import com.beauty.girlbeauty.databinding.ActivityPersonalInfoAdminBinding;
...
public class PersonalInfoAdminActivity extends AppCompatActivity {

    private ActivityPersonalInfoAdminBinding binding;
    private String dp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPersonalInfoAdminBinding.inflate(getLayoutInflater());
    ...
    private void formValidation() {
        ...
        if (fullName.isEmpty()) {
            ...
            Toast.makeText(this, "Shop Name must be filled!", Toast.LENGTH_SHORT).show();
